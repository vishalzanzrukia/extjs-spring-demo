...
=======
		////alert(item.getHeight());
>>>>>>> 1.3
	//	formPanel.setWidth(item.getWidth()+100);
...
>>>>>>> 1.3
	        	...
	        	//var droppedPanel = Ext.getCmp(ddSource.id);
	        	/*var sourceItemId=ddSource.id;//data.sourceEl.id;//ddSource.el.id
	        	var sourceItem=Ext.getCmp(sourceItemId); 
<<<<<<< searchBar2.js
	        	////////////////console.log('before ////////////////console.log(droppedPanel);');
	        	////////////////console.log(sourceItem);*/
	        	//////////////////console.log(sourceItem.alias[0]);
=======
	        	////console.log('before ////console.log(droppedPanel);');
	        	////console.log(sourceItem);*/
	        	//////console.log(sourceItem.alias[0]);
>>>>>>> 1.3
	        	//
	        	/*if(sourceItem.alias[0]=='widget.panel')
	        	{
<<<<<<< searchBar2.js
	        		//////alert('hello');
=======
...
>>>>>>> 1.3
	        		var droppedPanel = Ext.getCmp(ddSource.id);
<<<<<<< searchBar2.js
	        		//////////////////console.log(droppedPanel);
=======
	        		//////console.log(droppedPanel);
>>>>>>> 1.3
	        		//formPanel.add(droppedPanel);
	        		var destPanelId=formPanel.id;
<<<<<<< searchBar2.js
	        		////////////////console.log(destPanelId);
=======
	        		////console.log(destPanelId);
>>>>>>> 1.3
	        		var destPanel=Ext.getCmp(destPanelId);
<<<<<<< searchBar2.js
	        		////////////////console.log(destPanel);
=======
	        		////console.log(destPanel);
>>>>>>> 1.3
	        		for(i=0;i<sourceItem.items.items.length;i++)
	        		{
<<<<<<< searchBar2.js
	        			////////////////console.log('hi');
	        			////////////////console.log(sourceItem.items.items[i]);
=======
	        			////console.log('hi');
	        			////console.log(sourceItem.items.items[i]);
>>>>>>> 1.3
	        		}
	        		//destPanel.insert(1,droppedPanel);
<<<<<<< searchBar2.js
	        		//////alert('hi'+droppedPanel.caption);
=======
	        		////alert('hi'+droppedPanel.caption);
>>>>>>> 1.3
	        	}*/
...
function initializeDD(targetPanel)
{
	var v=targetPanel;
...
>>>>>>> 1.3
        var xyAry=new Array();
        xyAry[0]=Ext.fly(sourceEl).getX();
        xyAry[1]=Ext.fly(sourceEl).getY();
        if (sourceEl) {
...
<<<<<<< searchBar2.js
        	 //////////////////console.log('before targetPanel');
=======
        	 //////console.log('before targetPanel');
>>>>>>> 1.3
        	//if(droppedPanel.caption==null)
        	//{
<<<<<<< searchBar2.js
        		//////////////////console.log(droppedPanel);
=======
...
>>>>>>> 1.3
        		...
        		/*targetPanel.add(new Ext.button.Button({
        			text:'click'
        		}));*/
        		var temp_item;
        		try{
        			//targetPanel.add(droppedPanel);	
        			/*Ext.each(droppedPanel.items.items,function(item){
<<<<<<< searchBar2.js
            			////////////////console.log(item.id);
=======
            			////console.log(item.id);
>>>>>>> 1.3
            			temp_item=item.id;
            			var item11=Ext.getCmp(item.id);
            			targetPanel.add(item11);
            		});*/
        		}
        		catch(e)
        		{
...
>>>>>>> 1.3
     ...
     //
<<<<<<< searchBar2.js
      //////alert(droppedPanel.getId());
     // ////////////////console.log('before drooped panel');
      //////////////////console.log(droppedPanel);
      //////////////////console.log('before drooped panel');
      //////////////////console.log(targetPanel);
=======
...
>>>>>>> 1.3
      //
      //var items_count=targetPanel.items.length;
<<<<<<< searchBar2.js
