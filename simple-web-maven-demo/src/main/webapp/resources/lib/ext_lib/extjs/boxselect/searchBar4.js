	   ...
	   var dispalyField=this.displayField;
		var item = Ext.create('Ext.ux.BoxSelect.Item1', {
			...
			listeners: {
			    ...
			    {
			       mapPanelItem+=this.id+'_panel::'+this.id+'\n';
			    },
    			afterrender:function( item,eOpts)
    			{
			        
<<<<<<< searchBar4.js
    			   //////alert(this.value.data.v);
    			  /* var value=this.value.data.v;
    			   if(value=='v1')
=======
    			   ////alert(this.value.data.key_value);
    			  /* var value=this.value.data.key_value;
    			   if(value=='key_value1')
>>>>>>> 1.3
    			   {
		...
		var formPanel = Ext.create('Ext.Panel', {
	       ...
	       // labelWidth : 100,
			...
			listeners:{
				...
				//mapPanelItem+=this.id+'::'+item.id+'\n';
<<<<<<< searchBar4.js
				//    ////alert(item.value.data.v);
					//////alert('hi');
				     // //////////////////console.log(opts);
=======
				//    //alert(item.value.data.key_value);
					////alert('hi');
				     // ////console.log(opts);
>>>>>>> 1.3
...
>>>>>>> 1.3
		...
		var keyValue=item.value.data.v;
		
		//formPanel.insert(0,new Ext.form.NumberField({width:35}));
...
>>>>>>> 1.3
	        	//sourceItemId.
<<<<<<< searchBar4.js
	        	////////////////////console.log('source:'+sourcePanel);
	        	////////////////////console.log('dest:'+destPanelId);
	        	//////alert('meas:'+sourceItemId);
=======
	        	//////console.log('source:'+sourcePanel);
	        	//////console.log('dest:'+destPanelId);
	        	////alert('meas:'+sourceItemId);
>>>>>>> 1.3
	        	if(sourcePanelId!=destPanelId || sourceItemId.search('meas')==-1)
	        	{
...
>>>>>>> 1.3
	        		destPanel.insert(1,Ext.create('Ext.ux.BoxSelect.Item1', {
		    			...
		    			listeners: {
		    			    ...
		    			    beforerender:function(item,eOpts)
		    			    {
	        					mapPanelItem+=destPanelId+'::'+this.id+'\n';
	        					
		    			    },
		    			    afterrender:function( item,eOpts)
		    			    {
<<<<<<< searchBar4.js
	        		    	// ////alert(sourceItem.value.data.v);  
		    			    	//////alert('afterrender');
=======
	        		    	// //alert(sourceItem.value.data.key_value);  
		    			    	////alert('afterrender');
>>>>>>> 1.3
		    			    	//  var panelId=getPanelIdForInput(this.id);
		    					 //   var panel=Ext.getCmp(panelId);
		    			   //  destPanel.insert(0,new Ext.form.NumberField({width:50}));
		    			    // destPanel.doLayout();
  ...
  /*  style: {
   ...
   // html: '<h1 style="cursor:move">The title</h1>',
	...
	listeners:{
		...
		{
		        if(this.value.data.v.search("v1")!=-1)
		        {
...
=======
		   ...
		   // //alert(this.caption);
>>>>>>> 1.3
		//this.insert(1,new Ext.form.TextField({value:'hi'}));
<<<<<<< searchBar4.js
		   //////alert('onRender:'+this.value.data.v);
		    //////alert(getPanelIdForInput(this.id));
=======
		   ////alert('onRender:'+this.value.data.key_value);
		    ////alert(getPanelIdForInput(this.id));
>>>>>>> 1.3
		  /*  var panelId=getPanelIdForInput(this.id);
		    var panel=Ext.getCmp(panelId);
		    
		    panel.insert(0,new Ext.form.NumberField({width:50}));
		    panel.setWidth(panel.getWidth()+100);
		    */
			Ext.applyIf(this.renderData, {
				caption: this.caption//,
				// v:new Ext.form.NumberField({width:50})
			});
		...
		},//<div><input id="hi" style="none;" class="" type="number" name="favcolor" value="20"/></div>
		//{caption}<div class="deletebutton"><!-- --></div>
...
function getPanelIdForInput(itemId)
{
	    var arry=[];
		 arry=mapPanelItem.split('\n');
		for(i=0;i<arry.length-1;i++)
		{
			if(arry[i].search(itemId)!=-1)
			{
				return arry[i].split('::')[0];
			}
		}
		return null;
}
