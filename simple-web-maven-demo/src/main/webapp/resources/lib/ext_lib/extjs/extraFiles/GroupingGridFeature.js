 ...
 */
Ext.define('Ext.grid.feature.MyGrouping', {
    ...
    onGroupMenuItemClick: function(menuItem, e) {
    	//alert(" on group menu item click");
        var me = this,
    ...
    getGroupRows: function(group, records, preppedRecords, fullWidth) {
       ...
       // console.log("getGroupRows="+group.name);
        return group;
    },
